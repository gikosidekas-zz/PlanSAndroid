...
public class SubscribedPlansActivity extends AppCompatActivity implements Callback<List<PlanEntity>> {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_subscribed_plans);
    ...
    private void callYourCreatedPlansApi(){
        ...
        Call<List<PlanEntity>> call = PlanSApiAdapter.getApiService().getUserSubscribedPlans(globalVariable.getUser().getIdUsuario());
        call.enqueue(this);
    ...
    public void onResponse(Call<List<PlanEntity>> call, Response<List<PlanEntity>> response) {
        ...
        ListView listview = (ListView) findViewById(R.id.listViewRecommended_subscribed);
        ...
        listview.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent intent = new Intent(getApplicationContext(),UnsubscribePlanActivity.class);
    ...
    private void showProgress(final boolean show) {
        ...
        mLoginFormView = findViewById(R.id.listViewRecommended_subscribed);
        mProgressView = findViewById(R.id.login_progress_subscribed);
